...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	WxPanel->Connect( wxEVT_PAINT, wxPaintEventHandler( MyFrame1::WxPanel_Paint ), NULL, this );
...
MyFrame1::~MyFrame1()
{
	...
	WxPanel->Disconnect( wxEVT_PAINT, wxPaintEventHandler( MyFrame1::WxPanel_Paint ), NULL, this );
