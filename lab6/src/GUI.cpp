...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_scrolledWindow->Connect( wxEVT_PAINT, wxPaintEventHandler( MyFrame1::m_scrolledWindow_paint ), NULL, this );
...
MyFrame1::~MyFrame1()
{
	...
	m_scrolledWindow->Disconnect( wxEVT_PAINT, wxPaintEventHandler( MyFrame1::m_scrolledWindow_paint ), NULL, this );
